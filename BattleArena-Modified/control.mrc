...
on 1:START: {
  ...
  echo 12The Base Script can be found on: https://github.com/Iyouboushi/mIRC-BattleArena
  echo 12This Version is Modified by Serkons https://github.com/Serkons/AiroRPG 

  /.titlebar Battle Arena version $battle.version written by James  "Iyouboushi" modified by Serkons "steve"
  ...
  if ($sha1($read(key)) != 13038f7403aa91370be526fe197b31b37ba83240) { .remove key |  write key M`S)4:&ES(&=A;64@:7,@<G5N;FEN9R!T:&4@0F%S:6-S(&]F('1H92`"0@)AM='1L92`"00)R96YA($)A='1L92!3>7-T96T@8W)E871E9"!B>2`"2@)A;65SM(`))`GEO=6)O=7-H:2`M+2!!=F%I;&%B;&4@9F]R(&9R964@870Z`S$R'R!HM='1P<SHO+V=I=&AU8BYC;VTO27EO=6)O=7-H:2]M25)#+4)A='1L94%R96YAM#R!A;F0@;6]D:69I960@8GD@4V5R:V]N<R!H='1P<SHO+V=I=&AU8BYC;VTO/4V5R:V]N<R]!:7)O4E!'```` }
}
...
on 2:TEXT:!system admin*:?: { $bot.admin(list, private) }
on 2:TEXT:!system admin*:#: { $bot.admin(list) }
